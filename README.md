...
Motion diffusion was previously implemented using [PriorMDM](https://github.com/priorMDM/priorMDM) before switching to STMC; that legacy support has since been removed.
