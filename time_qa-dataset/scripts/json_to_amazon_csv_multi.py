...
# This can only be executed when the generated dataset only consists of multi questions
...
csv_path = os.path.join(root_dir, "mturk_multi.csv")

# Write the data to the CSV file
with open(csv_path, "w", newline="") as csv_file:
    writer = csv.writer(csv_file)
    writer.writerow(
        ["video_url", "question", "option_1", "option_2", "option_3"]
    )  # Write header
    ...
    for folder in folders:
        ...
        if os.path.isfile(json_path):
            ...
            for entry in qa_pairs:
                ...
                video_url = (
                    "https://github.com/Patrerror/TimeQAvideos/raw/main/multi/"
                    + folder
                    + ".mp4"
                )
                ...
                if random.randint(0, 10) == 0:
                    writer.writerow(
                        [
                            ...
                            "Select the radio button that says Apple!",
                            "Apple",
                            "Orange",
                            "Banana",
                        ]
                ...
                writer.writerow([video_url, question, option_1, option_2, option_3])
